...
class tmCombineDataCardInterface:
    def __init__(self, list_signalBinLabels, dict_signalBins_observedNEvents):
        ...
        self.signalBins_observedNEvents = dict_signalBins_observedNEvents
    ...
    def generateObservationsSection(self):
        ...
        for signalBinLabel in self.signalBinLabels:
            observationsLine += tmGeneralUtils.alignFixedWidthStringLeft(width=labelWidth, inputString=str(self.signalBins_observedNEvents[signalBinLabel]))
